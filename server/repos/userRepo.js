...
exports.addRequest = userEntity => {
    var sql = `insert into requests(name, phone, address, note, status) values('${userEntity.name}', '${userEntity.phone}', '${userEntity.address}', '${userEntity.note}','${userEntity.status}')`;
    return db.insert(sql);
}
